...
public class Board {
    ...
    private CollisionResolverManager collisionResolverManager;
    ...
    public void init(BoardConf conf) {
        ...
        holes = conf.getHoles();
        collisionResolverManager = new CollisionResolverManager(balls, Runtime.getRuntime().availableProcessors() + 1);
    }
